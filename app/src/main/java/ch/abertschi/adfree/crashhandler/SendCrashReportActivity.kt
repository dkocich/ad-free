...
class SendCrashReportActivity : AppCompatActivity(), View.OnClickListener, AnkoLogger {
    ...
    private fun setupUI() {
        ...
        val v: View = findViewById(R.id.crash_container)
        v.setOnClickListener(this)

        var typeFace: Typeface =
            Typeface.createFromAsset(baseContext.assets, "fonts/Raleway-ExtraLight.ttf")


        val title: TextView = findViewById(R.id.crash_Title)
        ...
        val subtitle: TextView = findViewById(R.id.debugSubtitle)
    ...
    override fun onClick(v: View) {
        ...
        logfile?.let {
            try {
                ...
                e.printStackTrace()
                Toast.makeText(
                    this, "No crash report available.",
                    Toast.LENGTH_LONG
                ).show()
            }
        } ?: run {
